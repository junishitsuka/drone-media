...
ActiveRecord::Schema.define(version: 20160224142806) do

  create_table "application_purposes", force: :cascade do |t|
  ...
  create_table "wp_application_purposes", force: :cascade do |t|
    t.integer "application_id", limit: 4,   null: false
    t.string  "purpose",        limit: 255, null: false
  end

  create_table "wp_applications", force: :cascade do |t|
    t.string   "pref",       limit: 255
    t.string   "name",       limit: 255
    t.string   "phone",      limit: 255
    t.string   "email",      limit: 255
